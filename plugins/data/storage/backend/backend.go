...
const (
	...
	ZK Backend = "zk"
	// REDIS v2.x backend
	REDIS_2 Backend = "redis3.x"
	// REDIS v3.x backend
	REDIS_3 Backend = "redis3.x"
	// BOLTDB backend
	...
	// ELASTICSEARCH v2.x backend
	ELASTIC_V2 Backend = "elastic2.x"
	// ELASTICSEARCH v3.x backend
	ELASTIC_V3 Backend = "elastic3.x"
	// ELASTICSEARCH v5.x backend
	ELASTIC_V5 Backend = "elastic5.x"

	// BLEVESEARCH backend
	BLEVESEARCH Backend = "bleve"
