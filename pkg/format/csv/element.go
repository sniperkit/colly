...
// CSVCallback is a type alias for OnCSV callback functions
type CSVCallback func(*HTMLElement)

// CSVCallbackContainer
type CSVCallbackContainer struct {

	// Selector specifies...
	Selector string `json:"-" yaml:"-" toml:"-" xml:"-" ini:"-" csv:"-"`

	// Function specifies...
	Function CSVCallback `json:"-" yaml:"-" toml:"-" xml:"-" ini:"-" csv:"-"`
